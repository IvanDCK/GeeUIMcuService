...
object ConvertUtils {
    fun intToHex(n: Int): String {
        ...
        var n: Int = n
        var sb: java.lang.StringBuilder = java.lang.StringBuilder(8)
        val a: String
...
//           LogUtils.logi("","content.charAt(i)_"+i +"_"+  intToHex(content.charAt(i)));
            result = result + intToHex(content.get(i).code)
        }
    ...
    fun decodeHexString(hexString: String): String {
        ...
        val results: Array<String?> = arrayOfNulls(hexString.length / 2)
